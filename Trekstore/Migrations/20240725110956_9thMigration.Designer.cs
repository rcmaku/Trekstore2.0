...
namespace Trekstore.Migrations
{
    ...
    [Migration("20240725110956_9thMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trekstore.Models.CategoriaProveedor", b =>
                {
                    b.Property<int>("CategoriaProveedorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CategoriaProveedorID"));

                    b.Property<string>("CategoriaProveedorDescripcion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CategoriaProveedorNombre")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("CategoriaProveedorID");
            ...
            modelBuilder.Entity("Trekstore.Models.Providers", b =>
                {
                    b.HasOne("Trekstore.Models.CategoriaProveedor", "CategoriaProveedor")
                        .WithMany("Providers")
