        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaDescripcion = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    purch_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Amount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseDetails", x => x.purch_id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseDetails_Providers_ProviderID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesDetails_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDetails_ProviderID",
                table: "PurchaseDetails",
                column: "ProviderID");

            migrationBuilder.CreateIndex(
                name: "IX_SalesDetails_ClientId",
                table: "SalesDetails",
                column: "ClientId");
